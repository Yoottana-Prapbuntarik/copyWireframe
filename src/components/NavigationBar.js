                ...
                <div>
                    <Navbar className="text-center  fixed-top" light style={alpha} expand="lg">
                        <div style={{ marginLeft: '2%' }}>
                            <NavLink className="navbar-brand" to="/">Navbar Brand</NavLink>
                        </div>
                        ...
                        <Collapse isOpen={this.state.isOpen} navbar>
                            <Nav className="ml-auto" navbar>
                                <NavItem className="navbarLink">
                                    <NavLink className="mr-2" to="/Login" onClick={this.closeNav}>
                                    ...
                                    <NavLink to="/Login" onClick={this.closeNav}>สวัสดี Tanyaporn</NavLink>
                                </NavItem>
                                <NavItem className="navbarLink">
                                    <NavLink
                                        to="#"
